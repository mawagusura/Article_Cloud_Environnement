...
![Figure 2. Evolution du POE entre 1985 et 2020. [^3]](0ab169d32f9ccd7863e3110a10a0f3b0.png)
...
![Figure 3. Evolution du POE et TUEE sur la période 2008-2020.[^3]](ce0cdb6240bb9e5420ac6e3b4716ff7b.png)
...
![Figure 3. Trends in global data center energy-use drivers [^3]](75724fb88d68c0c239fdff7bfafb5d5f.png)
...
* Scalability : une VM peut évoluer facilement en termes de ressources mais doit comprendre dans tous les cas l’OS ce qui alourdit la taille et ne permet pas un scale rapide. Alors que pour les conteneurs contiennent uniquement l’application et ses dépendances, qui sont par design prêt à être optimisé. Leur faible taille permet une bonne vélocité.
...
![Figure 4, The carbon benefits of Cloud Computing. []](68964cab626f8ba5d270edba49b94255.png)


Il est tout de même important de noter ces nouveaux usages liés au Cloud ont des impacts importants sur l'architecture logicielle des applications hébergées.
...
![Figure 5. Schéma de la négocation entre demande IT et production électrique. [^13]](9e5353077a3636c18ee53bcc4ff249d4.png)
...
Pourtant, cela n'est pas le cas : une étude finlandaise[^16] a tenté d’estimer, pour la téléphonie mobile, la consommation électrique du réseau par rapport au volume de données, autrement dit le nombre de kWh par gigaoctet transféré (kWh/Go).
...
![Figure 6. Evolution de la consommation du réseau internet mobile finlandais sur la période 2010-2017. [^16]](3870d6466265d055e101ddcbc49130d2.png)

On voit donc que l'intégration du Cloud dans son environnement technico-culturel est en constante évolution à mesure que ses infrastructres sous-jacentes sont prises en compte par les politiques publiques, les citoyens et les acteurs du secteur.
